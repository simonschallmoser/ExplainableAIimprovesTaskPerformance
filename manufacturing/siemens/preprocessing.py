...
con = sqlite3.connect("db_siemens_full.sqlite3")
...
data = data.loc[:,["study_group", "seen", "balanced_accuracy", "defect_detection_rate", "adherence_accurate_prediction", "overrule_wrong_prediction", "median_duration", "it_skills", "age", "education", "gender", "tenure"]]
...
columns = ["treatment", "completed_images", "balanced_accuracy", "defect_detection_rate", "adherence_accurate_prediction", "overrule_wrong_prediction", "median_decision_speed", "it_skills", "age", "education", "gender", "tenure"]
data.columns = columns
data.to_csv("data_study_02.csv", index=False)
